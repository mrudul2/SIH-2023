...
function Chat({socket,username,room}) {
  ...
  return (
    ...
    <input type='text' placeholder='Search for other patients' style={{marginLeft:"17px",height:"40px"
  ,width:"470px",padding: "10px",paddingLeft:"40px",fontSize:"20px"}}/><FaSearch style={{ marginLeft: "-460px", fontSize: "20px", color: "#999" }}/>
